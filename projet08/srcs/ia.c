...
/*   Updated: 2019/02/07 20:38:03 by ebatchas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_grille_score(t_grille *g, t_point p, t_point dir, t_player player)
{
	int		score;
	...
	if (player == YELLOW)
	{
	if (ft_grille_count(g, p, dir.x, dir.y) == 4)
		score += 100;
	if (ft_grille_count(g, p, dir.x, dir.y) == 2)
		if (
	}
}
